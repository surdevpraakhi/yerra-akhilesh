...
\item The angle of elevation of a cloud $\vec{C}$ from a point $\vec{P}$, $200$m above a still lake is $30^{\circ}$. If the angle of depression of the image of $\vec{C}$ in the lake from the point $\vec{P}$ is $60^{\circ}$, then $PC$ \brak{\text{in m}}
\begin{enumerate}
\begin{multicols}{4}
\item 200$\sqrt{3}$
\item 400$\sqrt{3}$
