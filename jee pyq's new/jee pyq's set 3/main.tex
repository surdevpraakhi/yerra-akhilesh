...
\item Let three distinct normal be drawn to the parabola $y^2+4y-6x-8=0$ from a point \brak{a,b} on the axis of the parabola. Then : \hfill{[12th April shift2,2023]}
\begin{enumerate}
...
\item For $p \in \mathbb N$, if the angle between pair of tangents drawn to the ellipse $3x^{2}+2y^{2}=5$ from the point \brak{1,p} is $\tan^{-1}\brak{\frac{12}{\sqrt{5}}}$, then the distance of the vertex of the parabola $y=x^2-px+p+1$ from the point \brak{-7,8} is equal to \underline{\hspace{1cm}} \hfill{[12th April shift2,2023]}\\
